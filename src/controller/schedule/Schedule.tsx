...
var ExerciseScheduleJSON: any = require("../../data/exercises/schedules/ExerciseSchedule.json");
var ScheduleDataJSON: any = require("../../data/exercises/schedules/ScheduleData.json");
