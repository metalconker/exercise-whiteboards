...
export enum Muscles {
  ...
  FOREARM_PRONATION = "Many muscles, including the flexors and extensors of the digits, a flexor of the elbow (brachioradialis), and pronators and supinators that turn the hand to face down or upwards, respectively.",
  ...
  HIP_FLEXION = "Several muscles that bring your legs and trunk together in a flexion movement.",
