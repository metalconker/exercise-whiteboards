...
export enum Muscle {
  ...
  "forearm#pronation" = "Many muscles, including the flexors and extensors of the digits, a flexor of the elbow (brachioradialis), and pronators and supinators that turn the hand to face down or upwards, respectively.",
  ...
  "hip#abduction" = "Group of muscles mostly used for bringing the thighs apart.",
  "hip#flexion" = "Several muscles that bring your legs and trunk together in a flexion movement.",
