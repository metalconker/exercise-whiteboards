...
export default class Routine {
  ...
  constructor(metaID: string) {
    this.metaID = metaID;
    this.alternating = RoutineModel.getIsAlternating(metaID);
    this.name = RoutineModel.getName(metaID);
    this.reps = RoutineModel.getNumReps(metaID);
    this.sets = RoutineModel.getNumSets(metaID);
    this.time = RoutineModel.getTime(metaID);
